...
class stepsIntakeController {
    ...
    static async createStepIntake(req, res) {
        try {
            const { userId, stepsTaken, recordedAt, timeInMins, distance, caloriesBurned } = req.body;
            ...
            if (existingStepLog) {
                ...
                await prisma.stepLog.update({
                    ...
                    data: {
                        ...
                        totalCaloriesBurned: existingStepLog.totalCaloriesBurned + caloriesBurned,
                        totalDistance: existingStepLog.totalDistance + distance,
                        totalTimeWalkedMins: existingStepLog.totalTimeWalkedMins + timeInMins
                    }
                });
