...
class MedicineController{
    ...
    static async createMedicine(req, res) {
        ...
        const { userId, name , quantity, date,  beforeOrAfterMeal, time, medType }  = req.body;

        try{


            console.log(userId, name , quantity, date,  beforeOrAfterMeal, time, medType)
            if(!userId || !name || !quantity  || !date || !beforeOrAfterMeal || !time || !medType){
