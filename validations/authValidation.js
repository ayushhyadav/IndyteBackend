...
export const registerSchema = vine.object({
  ...
  height: vine.string().nullable().optional(),
  height_unit: vine.string().nullable().optional(),
  weight: vine.string().nullable().optional(),
  weight_unit: vine.string().nullable().optional(),
